    ...
    <div class="row">
        <div class="col-sm-12 blog-main">
            <div class="row" style="font-size:13px;">
                <?php if ($me_count > 0) { ?>
                <form action="<?php echo base_url();?>/index.php?onpage=front&url=cart&a=update&item_id=0" method="post" name="cartform" id="cartform">
                    <table class="table table-bordered table-striped" style="color:#000;background-color: #fff;">
                        ...
                        <tbody>
                            ...
                            while ($rs_ct = $db->get($query_ct)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>/index.php?onpage=front&url=product&a=view&id=<?php echo $rs_ct['id']; ?>">
                                            <?php echo $rs_ct['name']; ?>
                                        </a>
                                    </td>
                                    ...
                                    <span class="glyphicon glyphicon-trash"></span>    <a role="button" class="btn btn-danger" href="<?php echo $baseUrl; ?>/index.php?onpage=front&url=cart&a=delete&item_id=<?php echo $rs_ct['id']; ?>">ลบ</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a role="button" class="btn btn-primary" href="<?php echo $baseUrl; ?>/index.php?onpage=front&url=cart&a=delete&item_id=<?php echo $rs_ct['id']; ?>">ใช่ ยืนยันการลบ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tr>
                            <td colspan="6" style="text-align: right;">
                                <h4>ราคาสินค้าทั้งหมด รวมภาษีมูลค่าเพิ่ม <?php echo number_format($total_price); ?> บาท</h4>
                                <h6 style="color:#red;">*ยังไม่รวมค่าจัดส่ง</h6>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" style="text-align: right;">
                ...
                <?php } else { ?>
                    <div class="alert alert-danger" role="alert" style="margin:15px;">
                        ...
                        <a href="<?php echo base_url(); ?>/index.php?onpage=front&url=product&a=index" class="alert-link">คลิกที่นี้</a>
                    </div>
                <?php } ?>
            </div>
        </div><!-- /.blog-main -->
