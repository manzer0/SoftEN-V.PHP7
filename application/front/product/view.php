                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <hr>
                            <form class="form-inline" role="form" action="https://techreview.link/soft/cart" method="post">
                                ...
                                <a href="https://techreview.link/soft/cart"><button type="submit" class="btn btn-success">หยิบใส่ตะกร้า</button></a>
                            </form>
                        </div>
                    </div>
            ...
            <div class="panel panel-primary">
                ...
                <ul class="list-group">
                    <?php while ($rs_ps = $db->get($query_ps)) { ?>
                        <li class="list-block">
                            <a href="<?php echo $baseUrl; ?>/index.php?onpage=front&url=product&a=view&id=<?php echo $rs_ps['id']; ?>">
